...
public class User {
    ...
    // Notification preferences: comma-separated disabled types, e.g. "LIKE,SHARE"
    ...
    public void initDefaults() {
        if (isVerified == null)
            isVerified = false;
        if (isVerifiedRequested == null)
            isVerifiedRequested = false;
        if (isPrivate == null)
            isPrivate = false;
        if (postsCount == null)
            postsCount = 0;
    ...
    public int getConnectionsCount() {
        return connectionsCount != null ? connectionsCount : 0;
    }
    ...
    public int getProfileCompletionPercentage() {
        return profileCompletionPercentage != null ? profileCompletionPercentage : 0;
    }
    ...
    public String getNotificationPrefs() {
        return notificationPrefs != null ? notificationPrefs : "";
    }
