...
public class ConnectionServiceImpl implements ConnectionService {
    ...
    public String sendConnectionRequest(Long senderId, Long receiverId) {
        ...
        Optional<Connection> reverseConnection =
                connectionRepository.findByReceiverAndSender(sender, receiver);
    ...
    public List<User> getConnections(Long userId) {
        ...
        List<Connection> sentConnections =
                connectionRepository.findBySenderAndStatus(user, ConnectionStatus.ACCEPTED);

        List<Connection> receivedConnections =
                connectionRepository.findByReceiverAndStatus(user, ConnectionStatus.ACCEPTED);
    ...
    public String removeConnection(Long userId1, Long userId2) {
        ...
        Optional<Connection> connection =
                connectionRepository.findBySenderAndReceiver(user1, user2);
